...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.chunking.maxDepth": "Memory Chunk Markdown Max Heading Depth",
  "agents.defaults.memorySearch.chunking.maxTokens": "Memory Chunk Max Tokens",
  "agents.defaults.memorySearch.chunking.targetTokens": "Memory Chunk Target Tokens",
  "agents.defaults.memorySearch.chunking.overlapSentences": "Memory Chunk Overlap Sentences",
  "agents.defaults.memorySearch.chunking.bufferSize": "Memory Chunk Semantic Buffer Size",
  "agents.defaults.memorySearch.chunking.breakpointPercentileThreshold": "Memory Chunk Semantic Breakpoint Percentile",
  "agents.defaults.memorySearch.chunking.theta": "Memory Chunk Lumber Theta",
  "agents.defaults.memorySearch.chunking.completionModel": "Memory Chunk Completion Model",
  "agents.defaults.memorySearch.chunking.windowSize": "Memory Chunk HiChunk Window Size",
  "agents.defaults.memorySearch.chunking.lineMaxLen": "Memory Chunk HiChunk Line Max Length",
  "agents.defaults.memorySearch.chunking.maxLevel": "Memory Chunk HiChunk Max Level",
  "agents.defaults.memorySearch.chunking.recurrentType": "Memory Chunk HiChunk Recurrent Type",
