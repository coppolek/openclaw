...
import { validateConfigGetParams, validateUpdateRunParams } from "../protocol/index.js";
import { getLatestUpdateRestartSentinel } from "../server-restart-sentinel.js";
...
export const updateHandlers: GatewayRequestHandlers = {
  "update.status": async ({ params, respond }) => {
    if (!assertValidParams(params, validateConfigGetParams, "update.status", respond)) {
      return;
    }
    respond(true, {
