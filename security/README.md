...
```bash
opengrep scan --no-strict --config security/opengrep/precise.yml --no-git-ignore src/
opengrep scan --no-strict --config security/opengrep/broad.yml   --no-git-ignore src/
```
